...
> 🔴 **iOS project? Read platform-ios.md FIRST!** 🔴 **Android project? Read platform-android.md FIRST!** 🔴 **Cross-platform? Read BOTH and apply conditional platform logic!**
...
> 🔴 **If you skip build verification and user finds build errors, you have FAILED.** 🔴 **"It works in my head" is NOT verification. RUN THE BUILD.**
